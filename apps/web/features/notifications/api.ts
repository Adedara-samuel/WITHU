...
export const notificationsApi = {
  ...
  markRead: (id: string) => apiFetch<{ read: boolean }>(`/api/notifications/${id}/read`, { method: "POST" }),
  ...
  completeDailyChallenge: () =>
    apiFetch<DailyChallenge>("/api/notifications/daily-challenge/complete", { method: "POST" }),
};
