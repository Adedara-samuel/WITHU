...
export function useMessages() {
  ...
  // Pages arrive newest-first; render oldest-fetched-page first so the transcript reads top-to-bottom.
...
/** Wires realtime chat events into the messages query cache; call once from the chat screen. */
